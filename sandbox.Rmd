...
mvspec(diff(terror4), kernel('modified.daniell', m), log="no", taper=0.1, main="Smoothed and Tapered Periodogram")
dev.off()
...
# sarima(terror4, 0, 1, 1, 1, 1, 1, 3)
# sarima(terror4, 0, 1, 1, 1, 1, 2, 3)
# 
# sarima(terror4, 1, 1, 2)
# sarima(terror4, 1, 1, 2, 1, 0, 1, 4)
# sarima(terror4, 1, 1, 2, 1, 1, 1, 4)
# sarima(terror4, 1, 1, 2, 1, 1, 2, 4)
# sarima(terror4, 1, 1, 2, 1, 0, 1, 3)
# sarima(terror4, 1, 1, 2, 1, 1, 1, 3)
# sarima(terror4, 1, 1, 2, 1, 1, 2, 3)
```
...
for (i in start_pts)
{
  ...
  predicted <- sarima.for(terror5, 12, 0, 1, 1, 1, 1, 1, 3)$pred
